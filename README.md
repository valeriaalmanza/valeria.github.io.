...
El planeta de los simios: (R)Evolución (Hispanoamérica)" <br><br></td>
							...
							<tr>
								...
								<td class="descripciones" style="color:white;">Animales,Mutación,Muerte,Experimentos,Virus,Violencia,Venganza<br><br></td>
							</tr>
							<tr>
...
<center>
					...
					<ul>
						<li><img src="james.jpg" alt=""></li>
						<li><img src="freida2.jpg" alt=""></li>
						<li><img src="jon.jpg" alt=""></li>
						<li><img src="brian.jpg" alt=""></li>
						<li><img src="tom.jpg" alt=""></li>
						<li><img src="andi.jpg" alt=""></li>
						<li><img src="david.jpg" alt=""></li>
						<li><img src="tyler.jpg" alt=""></li>
					</ul>	
				</div>
			</div>
</section>
...
<center>
<img src="descripcion.jpg"alt="" width="60%"height="30%">
</center>
</article>
...
<section class="seccion2" id="contaminacion">	
	<div class="centrar">
				<div class="imagenes-medio-ambiente">
					...
					<ul>
						<li><img src="labo.jpg" alt=""></li>
						<li><img src="labo1.jpg" alt=""></li>
						<li><img src="labo4.jpg" alt=""></li>
						<li><img src="labo3.jpg" alt=""></li>
						<li><img src="labo5.jpg" alt=""></li>
						<li><img src="labo6.jpg" alt=""></li>
						<li><img src="labo7.jpg" alt=""></li>
						<li><img src="labora1.jpg" alt=""></li>
					</ul>
			</div>	
